var attachVideojsHlsjsProvider = function (window, videojs, Hls) {
    function ProviderHLS (source, tech) {
        tech.name_ = 'HLS';
    ...
    if (Hls.isSupported()) {
        videojs.getComponent('Html5').registerSourceHandler({
            ...
            handleSource: function (source, tech) {
                ...
                tech.hlsProvider = new ProviderHLS(source, tech);
    ...
    videojs.ProviderHLS = ProviderHLS;
};

module.exports = attachVideojsHlsjsProvider;
